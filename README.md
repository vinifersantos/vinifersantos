...
**[Stack](#%EF%B8%8F-tecnologias-e-ferramentas) · [Sobre](#-sobre-mim) · [Projetos](#-projetos-em-destaque) · [Estudos](#-foco-de-estudos) · [Contato](#-contato)**
...
Sou um desenvolvedor em formação com experiência prática em **vendas, varejo, indicadores comerciais e criação de produtos**.

Minha direção é clara: transformar problemas operacionais em sistemas simples, mensuráveis e úteis. Por isso, estudo programação sem separar tecnologia de negócio — o código precisa melhorar uma operação, apoiar uma decisão ou criar uma nova fonte de valor.
...
```txt
STATUS      : construindo repertório técnico e projetos reais
DIREÇÃO     : desenvolvimento full stack orientado a produto
OBJETIVO    : criar sistemas próprios, escaláveis e comercializáveis
MÉTODO      : aprender → construir → medir → documentar → melhorar
DIFERENCIAL : tecnologia + vendas + estratégia + visão de operação
```
...
Também desenvolvo projetos privados voltados a **CRM, gestão financeira, produtividade e operações comerciais**, aplicando autenticação, bancos relacionais, dashboards e regras de negócio.
...
```yaml
perfil:
  programação: "aprendizado contínuo com aplicação prática"
  negócios: "vendas, varejo, indicadores e produtos"
  dados: "métricas que apoiam decisões"
  visão: "transformar ideias em sistemas úteis"
  estilo: "direto, estratégico e orientado a resultado"
  referências: "tecnologia, estoicismo, Bíblia, liderança e Star Trek"
```
...
- Regra de negócio deve ser compreendida antes de ser automatizada.
- Banco de dados, autenticação, segurança e deploy começam no planejamento.
- A interface deve parecer simples, mesmo quando o sistema é complexo.
- Documentar o raciocínio faz parte de aprender a programar.
- Código limpo é respeito por quem dará manutenção — inclusive meu eu do futuro.
...
<a href="https://github.com/vinifersantos">
  <img src="https://img.shields.io/badge/GitHub-vinifersantos-181717?style=for-the-badge&logo=github" alt="GitHub" />
</a>
